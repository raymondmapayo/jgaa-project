...
import AddExpensesSubCategoryModal from "../AdminModals/AddExpensesSubCategoryModal";
...
const AdminManageExpensesSubCategory = () => {
...
export default AdminManageExpensesSubCategory;
