...
import AddIngredientsModal from "../WorkerModals/AddIngredientsModal";
...
const WorkerManageIngredients: React.FC = () => {
...
export default WorkerManageIngredients;
